...
| `sentinel.training.telemetry` | learning-loop | preemptive-strike | `TrainingTelemetryEvent` |
| `sentinel.preemptive.signature` | preemptive-strike | api-gateway | `SignaturePublishedEvent` |
| `sentinel.preemptive.executed` | preemptive-strike | api-gateway | `PreemptiveExecutedEvent` |
| `sentinel.preemptive.alert` | preemptive-strike | ops / api-gateway | `AlertEvent` |
